...
def video_feed():
    ...
    frame_size = (int(request.headers.get('Frame-Width')), int(request.headers.get('Frame-Height')))
    return Response(status=200) #indicates that the data is sent to browser
